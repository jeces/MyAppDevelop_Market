...
//        val sf = SimpleDateFormat("yyyy년 MM월 dd일 HH:mm:ss", Locale.KOREA)
     ...
     **/
    fun setProductDetail(productId : String, productName: String, productPrice: Int, productDescription: String, productCount: String, pChatCount: Int, pViewCount: Int, pHearCount: Int, pBidPrice: Int, getPosition: Int) {
