...
class YourInfoAdapter(private val context: Context, var myId: String, var producFiretList: List<DocumentSnapshot>): RecyclerView.Adapter<YourInfoAdapter.Holder>() {
    ...
    override fun onBindViewHolder(holder: Holder, position: Int) {
        ...
        holder.itemView.product_price.text = "판매가 : ${context.getString(R.string.bid_price_format, formattedPrice)}"
        holder.itemView.current_bid_price.text = "입찰가 : ${context.getString(R.string.bid_price_format, formattedBidPrice)}"
