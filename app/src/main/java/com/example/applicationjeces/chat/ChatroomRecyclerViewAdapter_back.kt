...
//
//class ChatroomRecyclerViewAdapter_back(var chatRoomList: List<DocumentSnapshot>, var context: Fragment, var myId: String): RecyclerView.Adapter<ChatroomRecyclerViewAdapter.Holder>() {
//
